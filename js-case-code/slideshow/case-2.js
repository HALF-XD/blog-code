// https://zhuanlan.zhihu.com/p/151897269
var autoplay = true;
...
function initElement() {
    ...
    slider_items = slider_list.getElementsByClassName("slider-item");
    indicator_container = slider.querySelector(".indicator-container");

    let firstItem = slider_items[0].cloneNode(true); // 将第一张图片clone
    slider_list.appendChild(firstItem); // 放在最后一张

    slider_item_width = slider_items[0].offsetWidth; // 获取图片宽度
}
